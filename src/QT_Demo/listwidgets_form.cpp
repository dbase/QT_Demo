...
#include "ui_listwidgets_form.h"

#include "QListWidgetItem"

static bool can_check = false; //是否可编辑

listwidgets_form::listwidgets_form(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::listwidgets_form)
{
    ui->setupUi(this);
    listwidgetsInit();
}

listwidgets_form::~listwidgets_form()
{
    delete ui;
}

void listwidgets_form::listwidgetsInit()
{
    //初始化项
...
void listwidgets_form::on_btnInsert_clicked()
{
    // 在当前项之上，插入一项
...
void listwidgets_form::on_btnDelete_clicked()
{
    // 删除当前项
...
void listwidgets_form::on_btnCircle_clicked()
{
    // 遍历全部项，追加文本到每项
